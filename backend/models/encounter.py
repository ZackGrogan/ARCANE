...
class Encounter:
    def __init__(self, title: str, description: str, difficulty: str, npcs: List[NPC], monsters: List[str], environment: str, loot: List[str], notes: str, monster_data: List[Dict] = None):
        self.title = title
